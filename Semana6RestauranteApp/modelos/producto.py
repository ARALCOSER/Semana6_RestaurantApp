...
"""
# clase padre Producto que sirve como base para Platillo y Bebida
class Producto:
    """
    Clase padre que representa un producto general del restaurante. 
    Demuestra los principios de abstracción y encapsulación.
    """
    ...
    def cambiar_precio(self, nuevo_precio):
        # Actualiza el precio del producto validando que sea mayor a cero
        if nuevo_precio > 0:
