...
class Restaurante:
    """
    Clase de servicio encargada de administrar el catálogo de productos 
    y procesar la información de manera unificada.
    """
    ...
    def mostrar_menu_completo(self):
        # Recorre el catálogo dinámico y ejecuta el método correspondiente (POLIMORFISMO).
        print(f"\n=========================================")
        ...
        for producto in self.catalogo_productos:
            # Python identifica en tiempo de ejecución el tipo de instancia y ejecuta el método correcto.
